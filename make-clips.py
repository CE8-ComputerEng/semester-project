...
audio_output_paths = ['data/clips/wav',
                      'data/clips/wav',
                      'data/clips/wav',
                      'data/clips/wav',
                      'data/clips/wav',
...
audio_output_labels = ['data/clips/txt',
                       'data/clips/txt',
                       'data/clips/txt',
                       'data/clips/txt',
                       'data/clips/txt',
...
audio_output_times = ['data/clips/time',
                      'data/clips/time',
                      'data/clips/time',
                      'data/clips/time',
                      'data/clips/time',
...
def search_labels_for_clip(labels, clip_start, clip_end, padding=0):
    clip_start -= padding
    clip_end += padding
    ...
    for AUDIO_SOURCE_PATH, AUDIO_SOURCE_LABEL_PATH, AUDIO_OUTPUT_CLIP_PATH, AUDIO_OUTPUT_LABEL_PATH, AUDIO_OUTPUT_TIME_PATH, AUDIO_SOURCE_CHANNELS in zip(audio_paths, audio_labels, audio_output_paths, audio_output_labels, audio_output_times, audio_channels):
        ...
        for idx, channel in enumerate(audio):
            ...
            while end_sample < len(channel):
                ...
                clip_labels = search_labels_for_clip(labels, start_sample / SAMPLE_RATE, end_sample / SAMPLE_RATE, padding=CLIP_PADDING)
